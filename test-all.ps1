...
Run-Test "release-hardening opencode V2 lifecycle E2E" @("$ROOT\tests\release-hardening\opencode-v2-lifecycle.e2e.test.ts")
...
Run-Test "opencode guard V2 entrypoint (id + setup)" @("$ROOT\tests\adapter\opencode-guard-v2.test.ts")
