...
run_case 'git branch -D feature' deny 'git-branch-D'
run_case 'git branch --delete feature' deny 'git-branch-long-delete'
run_case 'git branch --delete --force feature' deny 'git-branch-long-delete-force'
run_case 'git branch --list' allow 'git-branch-list-safe'
